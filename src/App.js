...
import i1 from "./assets/images/4.png";
import i2 from "./assets/images/5.png";
import i3 from "./assets/images/6.png";
import i4 from "./assets/images/7.png";
import i6 from "./assets/images/8.png";
import i7 from "./assets/images/9.png";
import i8 from "./assets/images/10.png";
import i9 from "./assets/images/11.png";
import i10 from "./assets/images/12.png";
import i11 from "./assets/images/13.png";
import i12 from "./assets/images/14.png";
import i13 from "./assets/images/15.png";
import i14 from "./assets/images/16.png";
import i15 from "./assets/images/17.png";
import i16 from "./assets/images/18.png";
...
function App() {
  ...
  const claimNFTs = (_amount) => {
    ...
    setFeedback("Minting your CryptoAddict...");
    setClaimingNft(true);
    blockchain.smartContract.methods
      ...
      .then((receipt) => {
        let ownerBalance;
        let promise = blockchain.smartContract.methods.balanceOf(blockchain.account).call()
        .then((value) => {
          setFeedback(
            "WOW, you now own " + value + " CryptoAddicts. go visit Opensea.io to view it."
          );
        });
        setClaimingNft(false);
          ...
          <s.Container flex={1} ai={"center"} jc={"center"}>
            ...
            {Number(data.totalSupply) == 10000 ? (
              <>
                ...
                <s.SpacerSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  You can still find CryptoAddicts on{" "}
                  <a
                    target={"_blank"}
                    href={"https://opensea.io/collection/cryptoaddicts"}
                  >
                    Opensea.io
                  </a>
                </s.TextDescription>
              ...
              <>
                <s.TextTitle style={{ textAlign: "center" }}>
                  1 CryptoAddict costs {data.cost / 1e18} ETH.
                </s.TextTitle>
                <s.SpacerXSmall />
                <s.TextDescription style={{ textAlign: "center" }}>
                  Excluding gas fee.
